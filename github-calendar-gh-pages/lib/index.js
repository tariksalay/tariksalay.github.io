...
module.exports = function GitHubCalendar (container, username, options) {
    ...
    options = options || {};
    options.summary_text = options.summary_text || `Summary of pull requests, issues opened, and commits made by <a href="https://github.com/tariksalay" target="blank">@${username}</a>`;
